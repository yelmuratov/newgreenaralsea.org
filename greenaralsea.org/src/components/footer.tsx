    ...
    <footer data-aos="fade-up" className="mt-12 py-12 bg-[#57cc99] text-white">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-24">
          <ul className="flex flex-wrap justify-center md:justify-start">
            ...
            <li className="roboto-regular uppercase mx-2 md:mx-8 text-base md:text-xl mb-4 md:mb-0"><Link to="/contact">Contact us</Link></li>
            <li className="roboto-regular uppercase mx-2 md:mx-8 text-base md:text-xl mb-4 md:mb-0"><Link to="/termsofuse">Terms of use</Link></li>
          </ul>
